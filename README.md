...
This project implements a Black–Scholes option pricing model for European options, using historical price data to estimate annualized volatility and a U.S. 
Treasury–based risk-free rate. The codebase is structured with explicit validation, defensive error handling, and modular components to support future 
extensions such as Greeks, Monte Carlo pricing, and implied volatility estimation.


Data Source Considerations
This project intentionally does not rely on Yahoo Finance / yfinance. While commonly used for prototyping, Yahoo Finance is not an official or supported 
